...
module.exports = function (configApi) {
  ...
  return {
    ...
    queuing: {
      queueNames: utils.arrayFromString(environmentProvider.get('DASHBOARD_QUEUE_NAMES') || ['immediate', 'later', 'normal', 'soon', 'events']),
      messageRatesQueueNames: utils.arrayFromString(environmentProvider.get('DASHBOARD_MESSAGE_RATES_QUEUE_NAMES') || ['immediate', 'later', 'normal', 'soon', 'events']),
